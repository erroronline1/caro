...
* php.ini upload_max_filesize & post_max_size / applicationhost.config | web.config for sql server according to your expected filesize for e.g. sharepoint- and csv-files ~128MB
