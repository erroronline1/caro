...
* form components and forms need to be approved by a unit supervisor, quality management officer and ceo. respective user groups will be alerted by system message on saving of a new element.
...
#### purchase
* vendors only can be hidden, not deleted
