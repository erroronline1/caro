...
class _ERPINTERFACE {
	 ...
	 * as the interface must be adjusted to your specific usercase it is probably the easiest
	...
	*/
	...
	public function orderdata($from = null, $until = 'now'){
		 ...
		 * 			'article_no' => string,
		 * 			'article_name' => string,
		 * 			'identifier' => string, part of order text previously pasted during order process generated by caro app 
		 * 			'ordered' => Y-m-d H:i:s,
