...
if (in_array(REQUEST[0], ['application', 'form', 'user', 'consumables', 'order', 'message', 'file', 'tool', 'texttemplate', 'csvfilter', 'record', 'audit', 'schedule'])) require_once(REQUEST[0] . '.php');
