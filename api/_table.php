			...
			foreach($sheet as $row){
				...
				foreach($row as $column => $value){
					...
					$format = new \OpenSpout\Common\Entity\Style\Style(
						...
						\OpenSpout\Common\Entity\Style\Style::DEFAULT_FONT_COLOR, // public string $fontColor = self::DEFAULT_FONT_COLOR,
						\OpenSpout\Common\Entity\Style\Style::DEFAULT_FONT_NAME, // public string $fontName = self::DEFAULT_FONT_NAME,
						!empty($options['columns'][$column]['halign']) ? \OpenSpout\Common\Entity\Style\CellAlignment::{strtoupper($options['columns'][$column]['halign'])} : \OpenSpout\Common\Entity\Style\CellAlignment::LEFT, // public ?CellAlignment $cellAlignment = null,
						!empty($options['columns'][$column]['valign']) ? \OpenSpout\Common\Entity\Style\CellVerticalAlignment::{strtoupper($options['columns'][$column]['valign'])} : \OpenSpout\Common\Entity\Style\CellVerticalAlignment::TOP, // public ?CellVerticalAlignment $cellVerticalAlignment = null,
