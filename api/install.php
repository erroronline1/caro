	...
	'install' => [
		'mysql' => [
			...
			'insertions' => [
				...
				'form' => "INSERT INTO `caro_form_forms` (`id`, `name`, `date`, `author`, `content`) VALUES " .
					"(NULL, 'template', CURRENT_TIMESTAMP, '" . INI['caroapp']. "', '');",
		...
		'sqlsrv' => [
			...
			'insertions' => [
				...
				'form' => "INSERT INTO caro_form_forms (name, date, author, content) VALUES " .
					"('template', CURRENT_TIMESTAMP, '" . INI['caroapp']. "', '');",
