		...
		'mysql' => [
			...
			'insertions' => [
				...
				'component' => "INSERT INTO `caro_form_components` (`id`, `name`, `date`, `content`) VALUES " .
					"(NULL, 'template', CURRENT_TIMESTAMP, '{\"content\": [[{\"type\": \"text\",\"description\": \"This is an informative text\",\"content\": \"You can add some information or just use the description as a short info with icon\"}],[{\"type\": \"text\",\"description\": \"These are single input options\"}, {\"attributes\": {\"name\": \"This is a text input\"},\"type\": \"textinput\",\"hint\": \"...but only for short things\"}, {\"attributes\": {\"name\": \"This is also a text input\"},\"type\": \"textarea\",\"hint\": \"...but it allows more lines and linebreaks\"}, {\"attributes\": {\"name\": \"This is a number input\"},\"type\": \"numberinput\",\"hint\": \"Only numbers are allowed\"}, {\"attributes\": {\"name\": \"This is a date input\"},\"type\": \"dateinput\",\"hint\": \"You can use your operating systems date picker as well\"}],[{\"type\": \"text\",\"description\": \"These are multiple options inputs\"}, {\"type\": \"links\",\"description\": \"These are links\",\"hint\": \"They open in a new window or tab\",\"content\": {\"https:\/\/www.website.one\": [],\"https:\/\/intranet\": []}}, {\"type\": \"checkbox\",\"description\": \"This is a set of options\",\"hint\": \"Multiple options can be selected. It is recommended to not use more than 8 if possible.\",\"content\": {\"Checkbox 1\": [],\"Checkbox 2\": [],\"Checkbox 3\": []}}, {\"type\": \"radio\",\"description\": \"This is another set of options\",\"hint\": \"...but you can only select one. It is recommended to not user more than 8.\",\"content\": {\"Radio 1\": [],\"Radio 2\": [],\"Radio 3\": []}}, {\"attributes\": {\"name\": \"This is selection list\"},\"type\": \"select\",\"hint\": \"It opens in a modal but you can only select one. Recommended for longer lists.\",\"content\": {\"Item one\": [],\"Item two\": [],\"Item three\": []}}],[[{\"attributes\": [],\"type\": \"text\",\"description\": \"These are special inputs\"}, {\"attributes\": [],\"type\": \"file\",\"description\": \"You can upload files\",\"hint\": \"...and you can select if only one or multiple.\"}, {\"attributes\": [],\"type\": \"photo\",\"description\": \"You can add photos\",\"hint\": \"Desktop user can select images, mobile users access their camera\"}, {\"attributes\": {\"name\": \"You can scan 2d-codes as well\"},\"type\": \"scanner\",\"hint\": \"The button opens the scanner\"}],[{\"attributes\": [],\"type\": \"signature\",\"description\": \"This is a signature field to draw on\",\"hint\": \"Do not use more than one per form. Please be aware this is not certifed!\"}]]],\"form\": {}}');",
		...
		'sqlsrv' => [
			...
			'insertions' => [
				...
				'component' => "INSERT INTO caro_form_components (name, date, content) VALUES " .
					"('template', CURRENT_TIMESTAMP, '{\"content\": [[{\"type\": \"text\",\"description\": \"This is an informative text\",\"content\": \"You can add some information or just use the description as a short info with icon\"}],[{\"type\": \"text\",\"description\": \"These are single input options\"}, {\"attributes\": {\"name\": \"This is a text input\"},\"type\": \"textinput\",\"hint\": \"...but only for short things\"}, {\"attributes\": {\"name\": \"This is also a text input\"},\"type\": \"textarea\",\"hint\": \"...but it allows more lines and linebreaks\"}, {\"attributes\": {\"name\": \"This is a number input\"},\"type\": \"numberinput\",\"hint\": \"Only numbers are allowed\"}, {\"attributes\": {\"name\": \"This is a date input\"},\"type\": \"dateinput\",\"hint\": \"You can use your operating systems date picker as well\"}],[{\"type\": \"text\",\"description\": \"These are multiple options inputs\"}, {\"type\": \"links\",\"description\": \"These are links\",\"hint\": \"They open in a new window or tab\",\"content\": {\"https:\/\/www.website.one\": [],\"https:\/\/intranet\": []}}, {\"type\": \"checkbox\",\"description\": \"This is a set of options\",\"hint\": \"Multiple options can be selected. It is recommended to not use more than 8 if possible.\",\"content\": {\"Checkbox 1\": [],\"Checkbox 2\": [],\"Checkbox 3\": []}}, {\"type\": \"radio\",\"description\": \"This is another set of options\",\"hint\": \"...but you can only select one. It is recommended to not user more than 8.\",\"content\": {\"Radio 1\": [],\"Radio 2\": [],\"Radio 3\": []}}, {\"attributes\": {\"name\": \"This is selection list\"},\"type\": \"select\",\"hint\": \"It opens in a modal but you can only select one. Recommended for longer lists.\",\"content\": {\"Item one\": [],\"Item two\": [],\"Item three\": []}}],[[{\"attributes\": [],\"type\": \"text\",\"description\": \"These are special inputs\"}, {\"attributes\": [],\"type\": \"file\",\"description\": \"You can upload files\",\"hint\": \"...and you can select if only one or multiple.\"}, {\"attributes\": [],\"type\": \"photo\",\"description\": \"You can add photos\",\"hint\": \"Desktop user can select images, mobile users access their camera\"}, {\"attributes\": {\"name\": \"You can scan 2d-codes as well\"},\"type\": \"scanner\",\"hint\": \"The button opens the scanner\"}],[{\"attributes\": [],\"type\": \"signature\",\"description\": \"This is a signature field to draw on\",\"hint\": \"Do not use more than one per form. Please be aware this is not certifed!\"}]]],\"form\": {}}');",
